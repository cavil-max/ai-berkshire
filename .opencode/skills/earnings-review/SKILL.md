...
description: "AI Berkshire: 财报精读：一手资料深度解读"
---

## opencode adapter note

This skill is generated from `skills/earnings-review.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
