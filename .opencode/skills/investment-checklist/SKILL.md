...
description: "AI Berkshire: 巴菲特价值投资买入前 Checklist"
---

## opencode adapter note

This skill is generated from `skills/investment-checklist.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
