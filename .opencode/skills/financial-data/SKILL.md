---
name: financial-data
description: "AI Berkshire: 财务数据获取与交叉验证规范"
---

## opencode adapter note

This skill is generated from `skills/financial-data.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
