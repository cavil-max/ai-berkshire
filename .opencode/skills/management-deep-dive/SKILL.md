...
description: "AI Berkshire: 管理层纵深研究：买股票就是买人"
---

## opencode adapter note

This skill is generated from `skills/management-deep-dive.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
