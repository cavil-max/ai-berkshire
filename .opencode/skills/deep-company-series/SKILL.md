...
description: "AI Berkshire: 深度公司系列：8 篇长文拆一家公司"
---

## opencode adapter note

This skill is generated from `skills/deep-company-series.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
