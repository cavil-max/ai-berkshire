---
name: quality-screen
description: "AI Berkshire: 去劣筛选：7条指标快速排除非一流公司"
---

## opencode adapter note

This skill is generated from `skills/quality-screen.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
