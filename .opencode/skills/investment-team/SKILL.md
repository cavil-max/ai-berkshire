...
description: "AI Berkshire: 投研团队：四角色并行分析框架"
---

## opencode adapter note

This skill is generated from `skills/investment-team.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
