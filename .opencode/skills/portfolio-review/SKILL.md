...
description: "AI Berkshire: 组合管理：从\"研究公司\"到\"管理组合\""
---

## opencode adapter note

This skill is generated from `skills/portfolio-review.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
