---
name: earnings-team
description: "AI Berkshire: 财报精读团队：四大师并行解读 + 公众号发布"
---

## opencode adapter note

This skill is generated from `skills/earnings-team.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
