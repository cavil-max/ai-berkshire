---
name: thesis-drift
description: "AI Berkshire: 投资论文漂移检测：分清事实变化与措辞变化"
---

## opencode adapter note

This skill is generated from `skills/thesis-drift.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
