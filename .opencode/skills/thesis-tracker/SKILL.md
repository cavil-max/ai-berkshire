---
name: thesis-tracker
description: "AI Berkshire: 投资论文追踪：买入后的纪律系统"
---

## opencode adapter note

This skill is generated from `skills/thesis-tracker.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
