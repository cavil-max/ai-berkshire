---
name: wechat-article
description: "AI Berkshire: 微信公众号文章：作者-编辑-读者三Agent协作"
---

## opencode adapter note

This skill is generated from `skills/wechat-article.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
