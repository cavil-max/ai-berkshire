---
name: dyp-ask
description: "AI Berkshire: 段永平问答：以他的方式思考"
---

## opencode adapter note

This skill is generated from `skills/dyp-ask.md` so Claude Code, Codex, OpenClaw, and opencode users share one canonical workflow.
