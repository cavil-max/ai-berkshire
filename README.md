...
[实盘业绩](#real-track-record) · [为什么不能直接问AI](#为什么不能直接问-ai) · [Skills 一览](#skills-一览19个) · [快速开始](#快速开始) · [实战报告](#实战研究报告) · [设计理念](#设计理念) · [公众号](#实盘的下一步)
...
上面两张截图只是过去式。这套框架接下来的每一次调仓（先过[镜子测试](实盘记录/)再动手）、季度实盘复盘、新公司深度研究，都首发在微信公众号：
...
如果这个项目对你有帮助，请给一个 Star 支持！新报告与实盘复盘首发于微信公众号「**投资丹师**」（二维码见[文首](#实盘的下一步)）。
